...
class ImageClassifier:
    ...
    def _prepare_data(self, train_path, test_path, val_path):
        ...
        train_dataset = CustomImageDataset(root_dir=train_path, transform=train_transform,max_samples=None)
        test_dataset = CustomImageDataset(root_dir=test_path, transform=test_transform,max_samples=None)
        val_dataset = CustomImageDataset(root_dir=val_path, transform=test_transform,max_samples=None)
